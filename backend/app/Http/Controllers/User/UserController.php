...
class UserController extends Controller
{
     ...
     * mediaType="application/json",
     * @OA\Schema(
     * required={"email", "username", "password", "password_confirmation", "is_staff", "role"},
     ...
     * )
     */
    public function createStaffUser(RegisterUserRequest $request): JsonResponse
    {
        $checkAuthUser = $this->ensureAuthenticated();
